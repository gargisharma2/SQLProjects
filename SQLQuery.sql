...
INSERT INTO locations(location_id,street_address,postal_code,city,state_province,country_id) VALUES (2400,'8204 Arthur St',NULL,'Loxxndon',NULL,'UK');
...
select employee_id, first_name, last_name, department_name from employees inner join departments on employees.department_id=departments.department_id where department_name='IT'

select distinct job_title from jobs

select manager_id from employees where first_name='Diana'
select first_name from employees where employee_id=103

select first_name from employees where first_name LIKE 'D%'

select first_name from employees where first_name LIKE 'D%' OR first_name LIKE 'E%' OR first_name LIKE 'S%'
select first_name from employees where first_name LIKE '[DES]%'

select first_name from employees where first_name LIKE '[a-d]%'
select first_name from employees where first_name LIKE '[a-d,g-h,x-z]%'

select first_name from employees where first_name LIKE 'a___'
select distinct first_name from employees where first_name LIKE 'a___%'

select distinct first_name from employees where first_name LIKE 'a_' OR first_name LIKE 'a__' OR first_name LIKE 'a___'
...
WHERE salary BETWEEN 4000 AND 25000

select first_name, last_name, salary from employees where salary BETWEEN 4000 AND 25000
...
use HR_Database
select first_name from employees where department_id IN (1, 9, 11, 15)

select * from employees
select department_id, count(*) as num_employees from employees group by department_id

select first_name, department_id, max(salary) from employees group by first_name, department_id having max(salary)

select department_id, round(avg(salary),2) as round_value from employees group by department_id
